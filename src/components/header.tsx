      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            ...
            <span className="text-lg sm:text-2xl font-black text-gray-800 tracking-tight group-hover:text-blue-600 transition-colors duration-300">
              ReverseAuction
            </span>
          </Link>
          ...
          {user && (
            <nav className="hidden lg:flex items-center gap-2">
              <Link
                href="/auctions"
                className={`relative px-4 xl:px-6 py-2 xl:py-3 text-sm xl:text-base font-bold transition-all duration-300 rounded-xl hover:scale-110 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:shadow-lg hover:text-blue-600 group ${
              ...
              {isAdminOrAuctioneer && (
                <Link
                  href="/create-auction"
                  className={`relative px-4 xl:px-6 py-2 xl:py-3 text-sm xl:text-base font-bold transition-all duration-300 rounded-xl hover:scale-110 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-green-50 hover:shadow-lg hover:text-emerald-600 group ${
              ...
              {isAdmin && (
                <Link
                  href="/admin"
                  className={`relative px-4 xl:px-6 py-2 xl:py-3 text-sm xl:text-base font-bold transition-all duration-300 rounded-xl hover:scale-110 hover:bg-gradient-to-r hover:from-purple-50 hover:to-violet-50 hover:shadow-lg hover:text-purple-600 group ${
                    isActivePath("/admin")
            ...
            {user && (
              <div className="lg:hidden">
                ...
                >
                  ...
                  <SheetContent
                    side="right"
                    className="w-72 bg-white/95 backdrop-blur-md"
                  >
                    <SheetHeader>
                      ...
                      <div className="pt-6 mt-6 border-t border-gray-200">
                        ...
                        <div className="mt-4 space-y-2">
                          <Link
                            ...
                            onClick={closeMobileMenu}
                            className="flex items-center w-full p-3 text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition-colors duration-200"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center w-full p-3 text-sm font-medium text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200"
                          >
            ...
            {user && (
              <div className="lg:hidden">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent
                    className="w-56 shadow-xl border-0 bg-white/95 backdrop-blur-md mr-4"
                    align="end"
                    forceMount
                  >
                    <DropdownMenuLabel className="font-normal p-3">
                      <div className="flex flex-col space-y-1">
                        <p className="text-sm font-bold leading-none text-gray-800 truncate">
                          {user.displayName}
                        </p>
                        <p className="text-xs leading-none text-gray-500 font-medium truncate">
                          {user.email}
                        </p>
                        <p className="text-xs leading-none text-blue-600 font-semibold capitalize">
                          {user.role || "user"}
                    ...
                    <DropdownMenuItem asChild>
                      <Link
                        href={`/profile/${user.uid}`}
                        className="flex items-center p-3 font-medium hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 cursor-pointer"
                      >
                    ...
                    <DropdownMenuItem
                      onClick={logout}
                      className="flex items-center p-3 font-medium hover:bg-red-50 hover:text-red-600 transition-all duration-200 cursor-pointer"
                    >
